        ...
        try {
            ...
            if (rs.next()) {
                ...
                switch (rs.getString(1)) {
                    case "bicicletero":
                        p = new Bicicletero(usuario, password, rs.getString(2), "bicicletero");
                        break;
                    case "encargado":
                        p = new Encargado(usuario, password, rs.getString(2), "encargado");
                        break;
                    case "vendedor":
                        p = new Vendedor(usuario, password, rs.getString(2), "vendedor");
                        break;
                }
            }
            con.close();
